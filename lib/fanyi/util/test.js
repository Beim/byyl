...
test('LRRUN p-246 S,L 数组引用的翻译 + 类型判断+自动转换p250', (t) => {
    let starttime = new Date()
    print(starttime.toLocaleString())
    let grammarMd = `
        Px -> P
        P -> D S -> P-945
        ## P -> nP1 D S -> P-945
    ...
    `
    let inRes = [
        {typeName: 'integer', lexical: 'int'},
        {typeName: 'id', lexical: 'x'},
        {typeName: ';'},


        {typeName: 'integer', lexical: 'int'},
        {typeName: 'id', lexical: 'func'},

        {typeName: '('},
        {typeName: 'integer', lexical: 'int'},
        {typeName: 'id', lexical: 'z'},
        {typeName: ','},
        {typeName: 'integer', lexical: 'int'},
        {typeName: 'id', lexical: 'q'},
        {typeName: ')'},
        ...
        {typeName: 'id', lexical: 'x'},
        {typeName: '='},
        {typeName: 'num', lexical: '1'},
        {typeName: ';'},

        {typeName: 'id', lexical: 'x'},
        {typeName: '='},
        {typeName: 'id', lexical: 'asdf'},
        {typeName: ';'},
    ...
    for (let i in inRes) {
        ...
        inRes[i].line = 1
        if (!inRes[i].lexical)
            inRes[i].lexical = inRes[i].typeName
    }
    ...
    print(`\ncost time: ${(endtime - starttime) / 1000}`)
})
